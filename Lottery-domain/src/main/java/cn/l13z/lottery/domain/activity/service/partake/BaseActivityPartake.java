 ...
 * <p>
 * Created: 2024-05-19 00:08 <br> Description: 基本活动参与 <br>
 * <p>
...
public abstract class BaseActivityPartake extends ActivityPartakeSupport implements IActivityPartake {
    ...
    public PartakeResult doPartake(PartakeReq partakeReq) {
        ...
        // 查询活动账单
        ActivityBillVO activityBillVO = super.queryActivityBill(partakeReq);
        ...
        Result subtractionActivityResult = this.subtractionActivityStock(partakeReq);
