...
/**
 * ClassName:     IDrawAlgorithm.java <br>
 *
 * @author AlfredOrlando <br>
 * <p>
 * <p>
 * Created:  2024-05-14 22:54 <br> Description: 抽奖算法接口 <br>
 * <p>
 * Modification History: <br> - 2024/5/14 AlfredOrlando 抽奖算法接口 <br>
 */
public interface IDrawAlgorithm {
     ...
     * <p>
     * 元组数据作用在于讲百分比内(0.2、0.3、0.5)的数据，转换为一整条数组上分区数据，如下；
     * 0.2 = 0 ~ 0.2
